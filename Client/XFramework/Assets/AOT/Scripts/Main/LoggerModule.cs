...
public class LoggerModule : MonoBehaviour
{
    // 配置日志系统
    ...
    [SerializeField] private string LogFileDirectory = "SaveAsset/Logger/Out"; // 保留10个日志文件
    ...
    void Awake()
    {
        ...
        #if UNITY_EDITOR
        // 获取项目根目录（Application.dataPath的父目录）
                string projectRoot = Directory.GetParent(Application.dataPath).FullName;
                LogConfig.LogFileDirectory = Path.Combine(projectRoot, LogFileDirectory);
        #else
                LogConfig.LogFileDirectory = "";
        #endif
        Logger.Initialize();
#endif
    }
