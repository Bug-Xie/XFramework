...
public class HybridCLRModule : MonoBehaviour
{
    [Header("HybridCLR配置")]
    [SerializeField] private string packageName = "DefaultPackage";
    [SerializeField] private string hotUpdateAssemblyName = "HotUpdate.dll";
    [SerializeField] private string mainClassName = "GameMain";
    [SerializeField] private string mainMethodName = "Start";
    ...
    private async UniTask<bool> LoadJITDLL()
    {
        ...
        Assembly assembly = AppDomain.CurrentDomain.GetAssemblies()
            .FirstOrDefault(a => $"{a.GetName().Name}.dll" == hotUpdateAssemblyName);
    ...
    /// 进入主入口
    /// </summary>
    private async UniTask<bool> EnterMainEntry()
    {
